...
1. CI cross-compiles pinned `xai-org/grok-build` source for `i686-unknown-linux-musl`.
...
The i686 probe intentionally runs independently from the IPA workflow until the upstream portability patches are proven and vendored.
